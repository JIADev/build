...
namespace Harvester
{
    ...
    partial void DeleteCustomer(Customer instance);
		...
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), customerCode, repositoryURL, branch, feature, mercurialChangesetId, user, createdDateTime, summary, files, branches, bookmarks, issueNumber);
