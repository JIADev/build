<#	
	...
	===========================================================================
	 ...
	 Filename:     	jenkinsDebugDeployCreateSitePackage.ps1
	===========================================================================
	.DESCRIPTION
...
#
<#Debug locally
$ps_scripts_dir = "C:\dev\code\build\jenkins"
$ENV:WORKSPACE = "C:\TestJenkins\workspace\2095AU_hg"
$ENV:driver = "CUST2095AU"
$ENV:pkgs_dir = "C:\TestJenkins\pkgs"
$ENV:protect = $true
$build_time = "20180227111911"
$ENV:BUILD_NUMBER = "000"
$ENV:j6_version = "7.0.0"
#>
